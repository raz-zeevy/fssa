...
class MatrixTest(Controller):
    ...
    def test_simple_example(self):
        ...
        matrix_page.set_missing_ranges([[99.0, 99.0]] * 5)

        test_dir_path = os.path.dirname(os.path.abspath(__file__))
        data_file_path = os.path.join(test_dir_path, SIMPLE_DATA_PATH)
        matrix_page.set_data_file_path(data_file_path)
        ...
        self.next_page()
        try:
            self.output_path = get_abs_path(r"output\achieement_18_vars.fss")
    ...
    def test_achmot(self):
        ...
        try:
            self.output_path = get_abs_path(r"tests\matrix_test\output\achmot.fss")
