...
class GitUpdateNotifier:
    def __init__(self, email_sender: EmailSender):
        ...
        self.setup_exe_link = "https://raw.githubusercontent.com/raz-zeevy/fssa/main/releases/FssaSetup.exe"
        self.website_link = "https://raz-zeevy.github.io/fssa/"
    ...
    def create_update_email_content(self) -> Tuple[str, str]:
        ...
        subject = f"עדכון גרסה - FSSA {version}"
        ...
        <body>
            <div class="email-container">
                <div class="hebrew-text">התפרסמה גרסה חדשה לתוכנה FSSA.</div>
                ...
                <div class="hebrew-text">
                    או באתר:<br>
                    <span class="ltr-text"><a class="link" href="{self.website_link}">{self.website_link}</a></span>
                </div>
